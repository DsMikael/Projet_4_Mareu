...
public abstract class DummyMeetingGenerator {
        ...
        static {
                DUMMY_MEETINGS = Arrays.asList(
                        new Meeting(new DateTime(2021, 6, 30, 10, 0, 0),
                                new DateTime(2021, 6, 30, 11, 0, 0), "Meeting A",
                                DummyLocationGenerator.generateLocations().get(6),
                               Arrays.asList("maxime@lamzone.com", "alex@lamzone.com")),
                        new Meeting(new DateTime(2021, 6, 28, 15, 15, 0),
                                new DateTime(2021, 6, 29, 15, 30, 0), "Meeting B",
                                DummyLocationGenerator.generateLocations().get(0),
                                Arrays.asList("paul@lamzone.com", "viviane@lamzone.com")),
                        new Meeting(new DateTime(2021, 6, 27, 10, 30, 0),
                                new DateTime(2021, 6, 28, 14, 30, 0), "Meeting C",
