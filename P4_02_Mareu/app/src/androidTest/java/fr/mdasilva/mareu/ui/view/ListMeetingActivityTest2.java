...
public class ListMeetingActivityTest2 {
    ...
    public void listMeetingActivityTest2() {
                ...
                allOf(withId(R.id.form_subject),
                        childAtPosition(
                                childAtPosition(
                                        ...
                                        0),
                                0)));
        textInputEditText.perform(scrollTo(), replaceText("tset\n"), closeSoftKeyboard());

        pressBack();

        ViewInteraction textInputEditText2 = onView(
                allOf(withId(R.id.form_subject), withText("tset\n"),
                        childAtPosition(
                                childAtPosition(
                                        withId(R.id.form_subject_layout),
                                        0),
                                0)));
        textInputEditText2.perform(scrollTo(), replaceText("tset"));
                ...
                allOf(withId(R.id.form_subject2),
                        childAtPosition(
                                childAtPosition(
                                        ...
                                        0),
                                0)));
        textInputEditText4.perform(scrollTo(), replaceText("test@tset.hh"), closeSoftKeyboard());
        ...
        ViewInteraction materialButton = onView(
                allOf(withId(R.id.containedButton), withText("Ajout� la r�union"),
                        childAtPosition(
                                childAtPosition(
